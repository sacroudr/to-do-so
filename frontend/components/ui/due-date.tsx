...
> = {
  overdue: { className: "text-status-blocked font-semibold", Icon: AlertTriangle, title: "En retard" },
  soon: { className: "text-status-waiting font-medium", Icon: Clock, title: "Echeance imminente" },
